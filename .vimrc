...
autocmd FileType cpp    noremap runfile :w<CR>:!make clean<CR>:!make %:r<ENTER><ENTER>:!./%:r<CR>
autocmd FileType c      noremap runfile :w<CR>:!make clean<CR>:!make %:r<ENTER><ENTER>:!./%:r<CR>
